...
function buckpostprocedited

L = 57.024e-6; %Inductor
C = 473e-6; %Capacitor
R = 1.152/10; % Rload - HEAVY
D = 1/10; % Duty Cycle
...
initial_I = 378.79; % Initial Inductor Amps
...
%%%% Question 1 Part C, Part IV Code for HEAVY Load
...
subplot(5,1,4);
plot(k, vd, 'c');
ylabel("Diode i_D (V)"); % Y-Label for the graph
xlabel("Time (s)"); % X-Label for the graph
